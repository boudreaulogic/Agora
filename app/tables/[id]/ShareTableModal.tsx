        ...
        <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[85vh] flex flex-col">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 flex-shrink-0">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">Manage who has access and what they can do</p>
            </div>
            <button
              onClick={onClose}
            ...
            {activeTab === 'share' ? (
              <div className="space-y-6">
                  ...
                  <div className={`rounded-lg p-4 border ${inheritPermissions ? 'bg-purple-50 border-purple-200' : 'bg-amber-50 border-amber-200'}`}>
                    ...
                    {inheritPermissions && workspaceMembers.length > 0 && (
                      <div className="mt-3 pt-3 border-t border-purple-200">
                        <p className="text-xs font-medium text-gray-600 mb-2">Workspace members with access:</p>
                        <div className="space-y-1.5">
                          {workspaceMembers.map((m: any) => (
                            <div key={m.id} className="flex items-center justify-between text-xs">
                              <div className="flex items-center space-x-2">
                                <span className="text-gray-500">{m.user ? '👤' : m.group ? '👥' : '🛡'}</span>
                                <span className="text-gray-700">{m.user?.name || m.user?.email || m.group?.name || m.role?.name || 'Unknown'}</span>
                              </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Permission Levels</h4>
                  <div className="space-y-1.5">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-xs text-gray-500">Full control + can transfer ownership</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-xs text-gray-500">Manage structure, permissions, lock rows + inherits Editor</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-xs text-gray-500">Add and edit data + inherits Viewer</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-xs text-gray-500">View data only</span>
                    </div>
                  </div>
                </div>
                )}
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-sm font-semibold text-gray-900">Row-Level Security</h3>
                ...
                {/* Row Locking Info */}
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="text-sm font-semibold text-gray-900">Row Locking</h3>
                  <p className="text-xs text-gray-500 mt-1">
                    Only Owners and Admins can lock or unlock rows.
                    Locked rows become read-only for Editors and Viewers.
                  </p>
                  <div className="mt-3 flex items-center space-x-2 text-xs text-gray-500">
                    <span className="inline-flex items-center px-2 py-1 bg-gray-200 rounded text-gray-700">🔒 Lock</span>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="text-sm font-semibold text-gray-900">Column Permissions</h3>
                  <p className="text-xs text-gray-500 mt-1">
