...
export function LinkedRecordPicker({
  ...
  if (disabled) {
    return (
      <div className="w-full px-3 py-2 bg-gray-100 border border-gray-200 rounded-lg text-sm text-gray-500 cursor-not-allowed">
      ...
      >
        {selectedDisplay ? (
          <div className="flex items-center space-x-2 flex-1 min-w-0">
            ...
            <span className="truncate text-gray-900">{selectedDisplay}</span>
          </div>
        ) : (
        ...
        <div className="flex items-center space-x-1 flex-shrink-0">
          {selectedDisplay && (
            <button onClick={handleClear} className="p-0.5 hover:bg-gray-100 rounded" title="Clear">
        ...
        <div className="absolute z-50 mt-1 w-full bg-white border border-gray-200 rounded-lg shadow-lg max-h-64 overflow-hidden">
          ...
          <div className="p-2 border-b border-gray-100">
            <input
              ...
              className="w-full px-3 py-1.5 border border-gray-200 rounded text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent"
              onKeyDown={(e) => {
          ...
          <div className="max-h-48 overflow-y-auto">
            {loading ? (
              <div className="px-3 py-4 text-center text-sm text-gray-400">Loading records...</div>
