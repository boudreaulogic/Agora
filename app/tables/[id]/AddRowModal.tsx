        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Add New Row</h2>
              <button
                ...
                <div key={column.id}>
                  ...
                  {column.type === 'checkbox' && (
                    <div className="flex items-center">
                      ...
                      />
                      <span className="ml-2 text-sm text-gray-600 dark:text-gray-400">Check if yes</span>
                    </div>
                  )}
                </div>
              ))}
