    ...
    <div className="h-full overflow-y-auto">
      <div className="max-w-2xl mx-auto py-8 px-6">
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Configure SMTP to enable email notifications and approval emails. Passwords are encrypted at rest.</p>
        </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="password" value={settings.smtp_pass} onChange={e => setSettings(p => ({ ...p, smtp_pass: e.target.value.replace(/\s/g, '') }))}
                  placeholder="••••••••"
                  className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 dark:text-gray-200" />
                <p className="text-[9px] text-gray-400 dark:text-gray-500 mt-1">🔒 Encrypted with AES-256-GCM before storage</p>
              </div>
            </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm mt-6">
          <div className="p-6">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">Send a test email to verify your SMTP settings are working.</p>
